...
/**
 * Mojo used to download SQL file from Vertabelo API based on following parameters:
 * - destSQLFile - name of SQL destination file
 ...
 */
@Mojo( name = "vertabeloSQL")
public class VertabeloSQLMojo extends AbstractMojo
{

    public final String API_ADDR = "https://my.vertabelo.com/api/sql";
    ...
    @Parameter(defaultValue = "model.sql")
    String destSQLFile;
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            File file = new File("./" + destSQLFile);
